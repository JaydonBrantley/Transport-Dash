...
const AvgPassenger = document.getElementById('all-101-routes');
...
const PassengerRevenue = document.getElementById('all-102-routes');
...
const AvgTrip = document.getElementById('all-103-routes');
...
const StopBoarded = document.getElementById('all-104-routes');
...
const StopAlighted = document.getElementById('all-105-routes');
...
const UnlinkedPassenger = document.getElementById('all-106-routes');
